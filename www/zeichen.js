...
const ZEICHEN = {
  ...
  auge: ['M2 12s3.5-6 10-6 10 6 10 6-3.5 6-10 6-10-6-10-6z',
    'M12 9.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5z'],
  augezu: ['M3 3l18 18', 'M10.6 6.2A9.8 9.8 0 0 1 12 6c6.5 0 10 6 10 6a17 17 0 0 1-3.2 3.8',
    'M6.5 8.2A16.6 16.6 0 0 0 2 12s3.5 6 10 6c1.6 0 3-.3 4.2-.8',
    'M9.9 9.9a2.5 2.5 0 0 0 3.4 3.4'],
