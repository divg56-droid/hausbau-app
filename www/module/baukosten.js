// Baukostenrechner.
//
// Dieselbe Formel wie auf hausbauatlas.de/hausbau/baukostenrechner/ und in
...
// Quelle: hausbauatlas.de/hausbau/kosten-pro-qm/ und /hausbau/grunderwerbsteuer/.
const LAENDER = [
  ...
  rahmen.append(
    ...
    karte([
      ...
      el('p', {
        klasse: 'unterzeile',
        text:
          'Die m²-Spannen je Bundesland stammen aus der Baukosten-Übersicht von hausbauatlas.de ' +
